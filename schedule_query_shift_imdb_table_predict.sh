...
python train_model.py --query_path imdb_queries/q_train_queryshift_predict_01.txt --test_query_path imdb_queries/q_test_small_set.txt --algo lero --query_num_per_chunk 20 --output_query_latency_file lero_imdb_ori_train_queryshift_predict_01.log --model_prefix imdb_ori_query_shift_model_predict_01 --topK 3
